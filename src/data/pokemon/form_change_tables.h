...
static const struct FormChange sUnownFormChangeTable[] = {
    {FORM_CHANGE_MOVE, SPECIES_UNOWN_PRIME, MOVE_UNOWN_BLAST, WHEN_LEARNED},
    {FORM_CHANGE_ITEM_USE, SPECIES_UNOWN_PRIME,   ITEM_REVEAL_GLASS},
    {FORM_CHANGE_TERMINATOR},
};
static const struct FormChange sUnownPrimeFormChangeTable[] = {
    {FORM_CHANGE_MOVE, SPECIES_UNOWN, MOVE_UNOWN_BLAST, WHEN_FORGOTTEN},
    {FORM_CHANGE_BATTLE_SWITCH, SPECIES_UNOWN_PRIME_FINAL, ABILITY_POWER_OF_WORDS},
    {FORM_CHANGE_TERMINATOR},
};
