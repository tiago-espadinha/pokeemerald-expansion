...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNRESTRAINEDBYSPIRIT]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} became restrained by spirits!"),    
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] =
{
    ...
    [B_MSG_WRAPPED_SPIRIT_SHACKLE]= STRINGID_PKMNRESTRAINEDBYSPIRIT, // MOVE_SPIRIT_SHACKLE
